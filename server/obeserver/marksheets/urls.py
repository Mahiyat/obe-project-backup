...
urlpatterns = [
    re_path('cie/category/show/(\d{1,9})$',views.cie_category_show,name='cie_category_show'),
    re_path('cie/category/create/(\d{1,9})$',views.cie_category_create,name='cie_category_create'),
    re_path('cie/category/(\d{1,9})$', views.cie_category_detail, name='cie_category_detail'),
